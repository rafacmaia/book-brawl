export default function Footer() {
  return (
    <footer className="mt-auto flex w-screen flex-col items-center gap-2.75 px-4 pt-3 pb-2 text-center text-footer/75 [@media(min-height:700px)]:gap-3.75 [@media(min-height:700px)]:py-3 [@media(min-height:700px)]:sm:py-4">
